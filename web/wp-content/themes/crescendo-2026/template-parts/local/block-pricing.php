<?php
$title = crescendo_local('local-pricing-title');
$price = crescendo_local('local-pricing-price');
$priceSuffix = crescendo_local('local-pricing-price-suffix') ?: '/mois';
$features = crescendo_local('local-pricing-features');
$cta = crescendo_local('local-pricing-cta');
$table = crescendo_local('local-pricing-table');
$col1 = crescendo_local('local-pricing-col1-label') ?: 'Location 350€/mois';
$col2 = crescendo_local('local-pricing-col2-label') ?: 'Achat classique';
if (!$title && !$price) {
    return;
}
?>
