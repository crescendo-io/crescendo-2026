<?php
$eyebrow = crescendo_local('local-faq-eyebrow');
$title = crescendo_local('local-faq-title');
$items = crescendo_local('local-faq-items');
if (empty($items)) {
    return;
}
...
?>
<section class="service-faq-section service-section--alt" id="faq">
    <div class="container">
