...
require_once (__DIR__ . '/inc/sitemap-noise.php');
...
require_once (__DIR__ . '/inc/secteurs-hub-seo.php');
require_once (__DIR__ . '/inc/secteurs-hub-import.php');
...
require_once (__DIR__ . '/inc/services-hub-seo.php');
require_once (__DIR__ . '/inc/services-hub-import.php');
require_once (__DIR__ . '/inc/about-seo.php');
require_once (__DIR__ . '/inc/legal-seo.php');
require_once (__DIR__ . '/inc/sitemap-seo.php');
